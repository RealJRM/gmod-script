...
SKIN.Author 		= "AquaRex"
SKIN.DermaVersion	= 2
SKIN.GwenTexture	= Material( "gwenskin/cieroskin_t.png" )
...
derma.DefineSkin( "CISKINT", "Dark Spawnmenu", SKIN )
...
hook.Add( "ForceDermaSkin", "CISKINT.Force", function()
...
steamworks.DownloadUGC( 888392108, function( path )
	game.MountGMA( path )
end)
